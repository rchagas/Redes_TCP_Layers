...
**********************************************************************************/
	...
	private void getFileFromServeR() {
		...
		try {
			...
			System.out.printf("Pacotes com dados enviados pelo servidor: %d\nPacotes com dados que chegaram ao cliente: %d\n", numpac, npac_chegou);	
			System.out.printf("Perda de pacotes com dados: %d \n", numpac - npac_chegou);	

			if(numpac != npac_chegou || numpac==0){
